        ...
        <div style={{ backgroundColor: 'var(--cream)', paddingBottom: 88 }}>
          ...
          <div style={{ padding: '20px 16px 16px' }}>
                ...
                {product.colors.map((color) => {
                  ...
                  return (
                    <button key={color} onClick={() => setSelectedColor(color)} title={color}
                      style={{ width: 28, height: 28, borderRadius: '50%', backgroundColor: hex, border: sel ? '2px solid var(--black)' : (hex === '#FFFFFF' || hex === '#F5F0E8') ? '1px solid var(--border)' : '1px solid transparent', outline: sel ? '2px solid var(--cream)' : 'none', outlineOffset: '-3px', cursor: 'pointer', padding: 0, transition: 'transform 0.15s', transform: sel ? 'scale(1.15)' : 'scale(1)' }} />
                  );
                })}
              </div>
            </div>
            ...
            <AccordionItem title="Shipping & Returns">
              <p style={{ fontSize: 13, color: 'var(--dust)', lineHeight: 1.9 }}>Free shipping on orders above ₹999. Standard delivery 5–7 business days. Easy 15-day returns.</p>
            </AccordionItem>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '58% 42%', gap: 64, alignItems: 'start' }}>
            ...
            <div>
              ...
              <AccordionItem title="Shipping & Returns">
                <p style={{ fontSize: 13, color: 'var(--dust)', lineHeight: 1.9 }}>Free shipping on orders above ₹999. Standard delivery: 5–7 business days. Express delivery available at checkout. Easy 15-day returns on unworn items.</p>
              </AccordionItem>
